...
use stm32mp15xx::interrupt_service::Stm32mp1DefaultPeripherals;
...
static mut CHIP: Option<&'static stm32mp15xx::chip::Stm32f4xx<Stm32mp1DefaultPeripherals>> = None;
...
struct STM32F157C {
    ...
    led: &'static capsules::led::LedDriver<
        'static,
        LedLow<'static, stm32mp15xx::gpio::Pin<'static>>,
        4,
    >,
...
impl SyscallDriverLookup for STM32F157C {
...
impl
    KernelResources<
        stm32mp15xx::chip::Stm32f4xx<
            'static,
            stm32mp15xx::interrupt_service::Stm32mp1DefaultPeripherals<'static>,
        >,
    > for STM32F157C
{
...
unsafe fn setup_dma(
    dma: &stm32mp15xx::dma1::Dma1,
    dma_streams: &'static [stm32mp15xx::dma1::Stream; 8],
    usart2: &'static stm32mp15xx::usart::Usart,
) {
    use stm32mp15xx::dma1::Dma1Peripheral;
    use stm32mp15xx::usart;
...
unsafe fn set_pin_primary_functions(
    syscfg: &stm32mp15xx::syscfg::Syscfg,
    // i2c1: &stm32mp15xx::i2c::I2C,
    gpio_ports: &'static stm32mp15xx::gpio::GpioPorts<'static>,
) {
    ...
    // i2c1.enable_clock();
    // i2c1.set_speed(stm32mp15xx::i2c::I2CSpeed::Speed100k, 16);
    ...
    gpio_ports.get_pin(PinId::PA01).map(|pin| {
        pin.set_mode(stm32mp15xx::gpio::Mode::AnalogMode);
    });
    ...
    cortexm4::nvic::Nvic::new(stm32mp15xx::nvic::EXTI9_5).enable();
    ...
    for pin in pins.iter() {
        gpio_ports.get_pin(*pin).map(|pin| {
            pin.set_mode(stm32mp15xx::gpio::Mode::AlternateFunctionMode);
            pin.set_floating_state(gpio::FloatingState::PullUp);
            pin.set_speed();
            pin.set_alternate_function(stm32mp15xx::gpio::AlternateFunction::AF12);
        });
    }
...
unsafe fn setup_peripherals(
    tim2: &stm32mp15xx::tim2::Tim2,
    fsmc: &stm32mp15xx::fsmc::Fsmc,
    trng: &stm32mp15xx::trng::Trng,
) {
    // USART2 IRQn is 38
    cortexm4::nvic::Nvic::new(stm32mp15xx::nvic::USART2).enable();
...
unsafe fn get_peripherals() -> (
    &'static mut Stm32mp1DefaultPeripherals<'static>,
    &'static stm32mp15xx::syscfg::Syscfg<'static>,
    &'static stm32mp15xx::dma1::Dma1<'static>,
) {
    ...
    let exti = static_init!(stm32mp15xx::exti::Exti, stm32mp15xx::exti::Exti::new(syscfg));
    let dma1 = static_init!(stm32mp15xx::dma1::Dma1, stm32mp15xx::dma1::Dma1::new(rcc));

    let peripherals = static_init!(
        Stm32mp1DefaultPeripherals,
        Stm32mp1DefaultPeripherals::new(rcc, exti, dma1)
    );
...
pub unsafe fn main() {
    ...
    let chip = static_init!(
        stm32mp15xx::chip::Stm32f4xx<Stm32mp1DefaultPeripherals>,
        stm32mp15xx::chip::Stm32f4xx::new(peripherals)
    );
    CHIP = Some(chip);
    ...
    let led = components::led::LedsComponent::new().finalize(components::led_component_helper!(
        LedLow<'static, stm32mp15xx::gpio::Pin>,
        LedLow::new(
            base_peripherals
                .gpio_ports
                .get_pin(stm32mp15xx::gpio::PinId::PE00)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                .get_pin(stm32mp15xx::gpio::PinId::PE01)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                .get_pin(stm32mp15xx::gpio::PinId::PE02)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                .get_pin(stm32mp15xx::gpio::PinId::PE03)
                .unwrap()
        ),
    ));
    ...
    let button = components::button::ButtonComponent::new(
        ...
        components::button_component_helper!(
            stm32mp15xx::gpio::Pin,
            // Select
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32mp15xx::gpio::PinId::PA00)
                    .unwrap(),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32mp15xx::gpio::PinId::PG01)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32mp15xx::gpio::PinId::PF15)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32mp15xx::gpio::PinId::PF14)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32mp15xx::gpio::PinId::PG00)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            )
    ...
    .finalize(components::button_component_buf!(stm32mp15xx::gpio::Pin));
    ...
    let gpio = GpioComponent::new(
        ...
        components::gpio_component_helper!(
            stm32mp15xx::gpio::Pin,
            // Arduino like RX/TX
            0 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG09).unwrap(), //D0
            1 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG14).unwrap(), //D1
            2 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG13).unwrap(), //D2
            3 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PF04).unwrap(), //D3
            4 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG12).unwrap(), //D4
            5 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PF10).unwrap(), //D5
            6 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PF03).unwrap(), //D6
            7 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG11).unwrap(), //D7
            8 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PG10).unwrap(), //D8
            9 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PB08).unwrap(), //D9
            // SPI Pins
            10 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PA15).unwrap(), //D10
            11 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PA07).unwrap(),  //D11
            12 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PA06).unwrap(),  //D12
            13 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PA15).unwrap()  //D13

            // ADC Pins
            // Enable the to use the ADC pins as GPIO
            // 14 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PA01).unwrap(), //A0
            // 15 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PC01).unwrap(), //A1
            // 16 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PC03).unwrap(), //A2
            // 17 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PC04).unwrap(), //A3
            // 19 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PC05).unwrap(), //A4
            // 20 => base_peripherals.gpio_ports.get_pin(stm32mp15xx::gpio::PinId::PB00).unwrap() //A5
        ),
    )
    .finalize(components::gpio_component_buf!(stm32mp15xx::gpio::Pin));
    ...
    //     base_peripherals
    //         .gpio_ports
    //         .get_pin(stm32mp15xx::gpio::PinId::PG05)
    //         .unwrap(),
    // )
    ...
    //         // bus type
    //         capsules::bus::Bus8080Bus<'static, stm32mp15xx::fsmc::Fsmc>,
    //         // bus
    //         &bus,
    //         // timer type
    ...
    //         base_peripherals
    //             .gpio_ports
    //             .get_pin(stm32mp15xx::gpio::PinId::PD11)
    //     ),
    // );
    ...
    let adc_mux = components::adc::AdcMuxComponent::new(&base_peripherals.adc1)
        .finalize(components::adc_mux_component_helper!(stm32mp15xx::adc::Adc));
    ...
    let temp_sensor = components::temperature_stm::TemperatureSTMComponent::new(2.5, 0.76)
        .finalize(components::temperaturestm_adc_component_helper!(
            ...
            stm32mp15xx::adc::Adc,
            // chip select
            stm32mp15xx::adc::Channel::Channel18,
            // spi mux
            adc_mux
        ));
    ...
    // let adc_channel_0 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel1)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));

    // let adc_channel_1 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel11)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));

    // let adc_channel_2 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel13)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));

    // let adc_channel_3 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel14)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));

    // let adc_channel_4 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel15)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));

    // let adc_channel_5 =
    //     components::adc::AdcComponent::new(&adc_mux, stm32mp15xx::adc::Channel::Channel8)
    //         .finalize(components::adc_component_helper!(stm32mp15xx::adc::Adc));
